...
prepareSerializerContext('Deserialize / Type', () => {
    class Item
    {
        @Srlz.Expose()
        public id = 3;
    ...
    it('Array case', () => {
        ...
        const obj = serializer.deserialize(plain, { type: ExPlayer });
    ...
    it('Already in proper type (deeply deserialize)', () => {
        class ExPlayer
            extends Player
        {
            @Srlz.Expose()
        ...
        const obj = serializer.deserialize(sourceObj, { type: ExPlayer });
